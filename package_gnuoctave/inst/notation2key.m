...
## -*- texinfo -*-
## @deftypefn {Function File} {@var{n} =} notation2key(@var{notation}, @var{style})
##
## Convert a musical notation to associated piano key number
##
## @var{notation}: the musical notation as str
##
## @var{fs}: sampling frequency, by default 44100
##
## @var{style}: the stylethe of the notation, 'latin' or 'english' (by default latin)
##
## Returns @var{n} the corresponding piano key number.
## 
## @end deftypefn
